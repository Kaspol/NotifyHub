...
2. Отработка на практике:
   2.1. Внедрение SAST, SCA, DAST, сканирование секретов и контейнеров.
   2.2. Работа с OWASP API Security Top 10 - создание и устранение уязвимостей
   2.3. Docker-харденинг, k8s (RBAC, NetworkPolicy), IaC, мониторинг и логирование.
